    ...
    <div className="space-y-4 mt-6 flex flex-col h-full">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-between">
        <div className="flex items-center gap-3">
          <span className="text-sm font-medium text-brand-primary-3 dark:text-[#646979]">
            Оцените сервер:
          </span>
            ...
            {[1, 2, 3, 4, 5].map((star) => (
              ...
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                  <path 
                    className={hoveredRating >= star || rating >= star ? "text-[#f5be39]" : "text-[b0b8c6] dark:text-[#2e323d]"}
