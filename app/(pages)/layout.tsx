      ...
      <Image src="/bg-right-1.png" alt="Left" width={216} height={553} className="hidden lg:block absolute top-[480px] right-0 z-10" />
        <div className={`xl:w-[94%] mx-auto`}>
          ...
          <div className="relative z-50">
            ...
            <Image src="/bg-left-2.png" alt="Left" width={123} height={182} className="hidden lg:block absolute -top-1 -left-14 -z-10" />
            <Image src="/bg-top.png" alt="Left" width={185} height={128} className="hidden lg:block absolute -top-8 left-72 -z-10" />
            <Image src="/bg-right-2.png" alt="Left" width={111} height={145} className="hidden lg:block absolute top-1 -right-10 -z-10" />
            {children}
          </div>
          <Info />
        </div>
